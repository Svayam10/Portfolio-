                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            ...
                            <p>Developed the official website <a href="https://www.vjtiracing.in" target="_blank" rel="noopener noreferrer"><u>VJTI Racing</u></a> using ReactJS and Tailwind CSS for a dynamic user experience. Implemented backend automation with Google Apps Script, improving efficiency. Collaborated on design and features to enhance visibility and engagement.</p>
                        </div>
                    </div>
                </div>
            </div>
